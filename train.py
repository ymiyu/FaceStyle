...
def display_img(i,x,style,is_val=False):
    ...
    img = x
    if is_val:
        fname = './styleTransfer/images/output/%s_%d_val.png' % (style, i)
    else:
        fname = './styleTransfer/images/output/%s_%d.png' % (style, i)
    imsave(fname, img)
    print('Image saved as', fname)


def get_style_img_path(style):
    return "./styleTransfer/images/style/"+style+".jpg"
...
def main(args):
    ...
    nb_epoch = 82785 *2
    train_batchsize = 1
    train_image_path = "./styleTransfer/images/train/"
